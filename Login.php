...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Log In &middot; Neobserver</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <form class="form-signin">
        ...
        <button class="btn btn-large btn-primary" type="submit">Log In</button> <button class="btn btn-large btn-primary" type="submit">Register</button>
      </form>
