...
<html lang="en">
  ...
  <body>
      ...
      <form class="form-signin" method="post">
        ...
        <input type="password" class="input-block-level" placeholder="Verify Password" name="Pass2">
        ...
        <input type="text" class="input-block-level" placeholder="Occupation" name="Occupation">
        <input type="text" class="input-block-level" placeholder="Org." name="Organization">

        <label class="checkbox">
          <input type="checkbox" value="remember-me"> I'm agree with the Terms
        </label>
